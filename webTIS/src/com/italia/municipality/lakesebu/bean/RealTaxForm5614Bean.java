 ...
 *
 */
@ManagedBean(name="form5614Bean", eager=true)
@ViewScoped
public class RealTaxForm5614Bean {

	private List<ITaxPayorTrans> trans = Collections.synchronizedList(new ArrayList<ITaxPayorTrans>());
	...
	private List<ITaxPayerReceipt> receipts = Collections.synchronizedList(new ArrayList<ITaxPayerReceipt>());
	...
	private List<ITaxPayor> payorLand = Collections.synchronizedList(new ArrayList<ITaxPayor>());
	...
	private List<ITaxPayor> payorSearchData = Collections.synchronizedList(new ArrayList<ITaxPayor>());
	...
	public void init(){
		...
		trans = Collections.synchronizedList(new ArrayList<ITaxPayorTrans>());
...
//		
    ...
    public void updateTotal(){
    	Double amnt = 0d;
    	Double tmpamnt = 0d;
    	List<ITaxPayerReceipt> tmpreceipts = Collections.synchronizedList(new ArrayList<>()); 
    	setGrandTotal(amnt);
	...
	public void newForm(){
		...
		clearFields();
		receipts = Collections.synchronizedList(new ArrayList<ITaxPayerReceipt>());
...
private void close(Closeable resource) {
	...
	public void viewLandOwner(ITaxPayerReceipt payerReceipt){
		...
		payorLand = Collections.synchronizedList(new ArrayList<ITaxPayor>());
	...
	public void payorLookup(){
		...
		String[] params = new String[0];
		payorSearchData = Collections.synchronizedList(new ArrayList<ITaxPayor>());
