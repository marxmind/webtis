 ...
 * <p>
 * Here are basic examples of valid properties for a database with the name 'bank_cheque':
 * <pre>
 * javabase.jdbc.url = jdbc:mysql://localhost:3306/bank_cheque
 * javabase.jdbc.driver = com.mysql.jdbc.Driver
 * javabase.jdbc.username = ****
 * javabase.jdbc.password = ******
 * </pre>
 * <pre>
 * javabase.jndi.url = jdbc/bank_cheque
 * </pre>
 * Here is a basic use example:
 * <pre>
 * DAOFactory bankcheque = DAOFactory.getInstance("italia.jdbc");
 * UserDAO userDAO = bankcheque.getUserDAO();
 * </pre>
 * 
 * @author ark
 *
...
public abstract class DAOFactory {
     ...
     */
    public ChequedtlsDAO getChequedtlsDAO() {
        return new ChequedtlsDAOJDBC(this);
    }
