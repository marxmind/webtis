...
public class CashDisbursementReport {
	...
	public static CashDisbursementReport retrieveOne(long id){
		...
		String sql = "SELECT * FROM cashdisbursementreport  WHERE  isactivez=1 AND isactivez=" + id;
	...
	public static List<CashDisbursementReport> retrieve(String sql, String[] params){
		...
		String tableCaz = "cz";
		String sqlAdd = "SELECT * FROM cashdisbursementreport "+tableCaz+"  WHERE  "+tableCaz+".isactivez=1 ";
